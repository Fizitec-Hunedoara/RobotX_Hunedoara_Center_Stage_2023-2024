...
public class Var_Blue {
    ...
    public static double Day_Hhigh = 120, Day_Shigh = 255, Day_Vhigh = 255, Day_Hlow = 90, Day_Slow = 50, Day_Vlow = 100;
    public static double Night_Hhigh = 180, Night_Shigh = 255, Night_Vhigh = 255, Night_Hlow = 90, Night_Slow = 150, Night_Vlow = 10;
